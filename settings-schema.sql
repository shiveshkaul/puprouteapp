...
-- Run this to add settings functionality to your existing database

-- User Settings table for notification preferences and other settings
...
CREATE TABLE IF NOT EXISTS public.payment_methods (
  ...
  provider_payment_method_id text NOT NULL, -- Stripe payment method ID, PayPal reference, etc.
  
  -- Card details (for display purposes - never store actual card numbers)
...
-- User Sessions table for tracking login history and app usage
...
-- This creates sample billing transactions for demo purposes
...
SELECT 
  ...
  'completed',
  'stripe',
  'pi_sample_' || generate_random_uuid()::text,
  2999, -- $29.99
...
-- Create sample payment method for demo
